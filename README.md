...
프로젝트 계기 : 현 회사의 전략기획팀에서 데이터 관련 회의를 하는 도중 솔루션 회사에서 파이프라인 설계하고 개발해주는데 파이프라인 하나 당 1000만원을 요구했다는 말을 흘려듣고 '그 돈 제가 아껴드리겠습니다.'하고 프로젝트 시작
...
성과 : 파이프라인 하나 당 1000만원을 아낄 수 있게 되었고 데이터를 늘 수작업으로 옮겨주는 번거로움과 비용(시간)을 매주 약 1~2시간을 아낄 수 있었습니다.
